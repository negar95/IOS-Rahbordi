...
class EducationalSummaries: UIViewController, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource, NVActivityIndicatorViewable, InternetStatusIndicable {
    ...
    override func viewDidLoad() {
        ...
        self.startAnimating(size, message: "بارگیری خلاصه دروس...", type: .triangleSkewSpin, color: .green, textColor: .white)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "pdfView"{
            ...
            pdfView.teacherName = "\(summArr[currentIndexPath].TeacherName)"
        }
