...
class TopicsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, NVActivityIndicatorViewable, InternetStatusIndicable {
    ...
    override func viewDidLoad() {
        ...
        self.startAnimating(size, message: "بارگیری مباحث...", type: .triangleSkewSpin, color: .purple , textColor: .white)
