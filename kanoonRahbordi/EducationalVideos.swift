...
class EducationalVideos: UIViewController, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource, NVActivityIndicatorViewable, InternetStatusIndicable {
    ...
    override func viewDidLoad() {
        ...
        self.startAnimating(size, message: "بارگیری فیلم های آموزشی...", type: .triangleSkewSpin, color: .blue, textColor: .white)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if moviesInfo[indexPath.row].Comment == nil{
