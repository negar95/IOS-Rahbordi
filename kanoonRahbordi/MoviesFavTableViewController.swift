...
class MoviesFavTableViewController: UITableViewController, NVActivityIndicatorViewable, InternetStatusIndicable {
    var sumcrsid = Int()
    var sumsbjid = Int()
    var groupCode = Int()
    var id: Int = 0
    ...
    override func viewDidLoad() {
        ...
        self.startAnimating(size, message: " بارگیری فیلم‌های مورد علاقه...", type: .triangleSkewSpin, color: .blue, textColor: .white)
        getFavInfo(URl: url){
            response , error in
            if response != nil{
